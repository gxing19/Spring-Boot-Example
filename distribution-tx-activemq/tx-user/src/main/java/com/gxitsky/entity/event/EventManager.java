package com.gxitsky.entity.event;

import com.alibaba.fastjson.JSON;
import com.gxitsky.entity.Score;
import com.gxitsky.repository.EventRepository;
...
public class EventManager {
    ...
    public void sendEventQueue(String queueName, Event event) {
        jmsTemplate.convertAndSend(queueName, JSON.toJSONString(event));
        this.updateEventProcessToPublished(event);
    }
